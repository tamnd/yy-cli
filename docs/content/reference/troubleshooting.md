...
Most of these come down to network reality or how yy serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

yy rate-limits like any public site. yy already paces
...
Where a surface is gated, yy reads a cookie or token you supply
...
`yy`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what yy actually did
